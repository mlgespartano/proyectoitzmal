...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<center><h3>Nuevas Solicitudes</h3></center>
			<br>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($reserva as $sol)
				<tr>
					...
					<td>
						<a href="{{URL::action('SolicitudesController@edit',$sol->id_reserva)}}"><button class="btn btn-info">Editar</button></a>
                         <a href="" data-target="#modal-delete-{{$sol->id_reserva}}" data-toggle="modal"><button class="btn btn-danger">Procesar</button></a>
					</td>
				</tr>
